...
function increaseNumberAnimationStep (i, element, endNumber) {
  ...
  document.querySelector('#budget').addEventListener('change', function handleSelectChange(event) {
    if (event.target.value === 'other') {
      ...
      document.querySelector('.form__containter form').insertBefore(formContainer, document.querySelector('.form__submit')); 
    ...
    if (event.target.value !== 'other'&& otherInput) {
      ...
      document.querySelector('.form__containter form').removeChild(otherInput);
    }
  });
